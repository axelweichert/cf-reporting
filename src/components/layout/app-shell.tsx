...
export default function AppShell({ children }: { children: React.ReactNode }) {
  ...
  const { authenticated, capabilities, role, loading, setAuth, setLoading } = useAuth();
  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-zinc-100">
      <Sidebar collapsed={sidebarCollapsed} permissions={permissions} role={role} />
