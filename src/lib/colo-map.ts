/**
 * Cloudflare edge location IATA code mapping – shared between browser and server code.
 * Source: https://speed.cloudflare.com/locations
 */

export const COLO_MAP: Record<string, { city: string; country: string }> = {
...
export function resolveColoCode(code: string): { city: string; country: string } {
